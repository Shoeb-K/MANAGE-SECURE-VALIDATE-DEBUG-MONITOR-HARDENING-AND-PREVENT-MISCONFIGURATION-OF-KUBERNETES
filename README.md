...
- ✅ Limit access to Kubernetes Cloud Provider API. Apply the least privilege in the Authorization IAM.
...
es any IAM (identity and access management) or RBAC policies.
